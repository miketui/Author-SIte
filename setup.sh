...
# ============================================================
# Runs PRD v2.1 Phases 0-2: repo clone, Claude Code install,
# 6 plugins, 3 design tools, MCP registration, .claude/ scaffolds,
# community skill review gates, and verification.
#
# Usage:
...
# ────────────────────────────────────────────────────────────
# STEP 2 — REPO CLONE (DESTINATION + SOURCE)
# ────────────────────────────────────────────────────────────
...
# Motion+ skipped per PRD v2.1 §14 item 14
...
4. Review staged community skills in docs/:
   docs/community-skills-reviewed-emilkowalski/   (may conflict with motion policy)
   docs/community-skills-reviewed-impeccable/     (if staged)
   docs/community-skills-reviewed-taste/          (always staged, manual verify)

5. Paste the build kickoff prompt (Claude-Code-Kickoff-Prompt.md)
   into Claude Code to begin Phase 3 onward.
